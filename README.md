...
does not explode. For each point, is done by checking that $\mathrm{Re}^2(z_n) + \mathrm{Im}^2(z_n) \leq 4$ for $n$ less than or equal to some maximum number of iterations.
